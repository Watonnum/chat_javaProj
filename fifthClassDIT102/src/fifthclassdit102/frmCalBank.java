 ...
 * @author ipae
 */
public class frmCalBank extends javax.swing.JFrame {

    /**
     * Creates new form frmCallBank
     */
    public frmCalBank() {
        initComponents();
    }
    ...
    private void btnCalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalActionPerformed
        ...
        //1000
        int b1000 = (int) (money/1000);
        txt1000.setText(b1000 + "");
        money = money % 1000;
        txtRemain.setText(money + "");
        
        //500
        int b500 = (int) (money/500);
        txt500.setText(b500 + "");
        money = money % 500;
        txtRemain.setText(money + "");
        
        //100
        int b100 = (int) (money/100);
        txt100.setText(b100 + "");
        money = money % 100;
        txtRemain.setText(money + "");
        
        //50
        int b50 = (int) (money/50);
        txt50.setText(b50 + "");
        money = money % 50;
        txtRemain.setText(money + "");
        
        //20
        int b20 = (int) (money/20);
        txt20.setText(b20 + "");
        money = money % 20;
        txtRemain.setText(money + "");
        
        //10
        int b10 = (int) (money/10);
        txt10.setText(b10 + "");
        money = money % 10;
        txtRemain.setText(money + "");
        ...
        //0.50
        int b050 = (int) (money/0.50);
        txt050.setText(b050 + "");
        money = money % 0.50;
        txtRemain.setText(money + "");
        
        //0.25
        int b025 = (int) (money/0.25);
        txt025.setText(b025 + "");
        money = money % 0.25;
        
        
        txtRemain.setText(String.format("%.2f", money));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCalBank.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCalBank().setVisible(true);
            }
        });
    }
