 ...
 * @author ipae
 */
public class OperationCalculate_switch extends javax.swing.JFrame {

    /**
     * Creates new form OperationCalculate_switch
     */
    public OperationCalculate_switch() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OperationCalculate_switch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OperationCalculate_switch().setVisible(true);
            }
        });
    }
