 ...
 * @author ipae
 */
public class maximumValue extends javax.swing.JFrame {

    /**
     * Creates new form maximumValue
     */
    public maximumValue() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(maximumValue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new maximumValue().setVisible(true);
            }
        });
    }
