 ...
 * @author ipae
 */
public class frmCalCircle extends javax.swing.JFrame {

    /**
     * Creates new form frmCalCircle
     */
    public frmCalCircle() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCalCircle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCalCircle().setVisible(true);
            }
        });
    }
