 ...
 * @author ipae
 */
public class frmTestCHello extends javax.swing.JFrame {

    /**
     * Creates new form frmTestCHello
     */
    public frmTestCHello() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String someone = txtTextfield.getText();
        CHello c = new CHello(someone);
        JOptionPane.showMessageDialog(this, c.greeet());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTestCHello.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmTestCHello().setVisible(true);
            }
        });
    }
